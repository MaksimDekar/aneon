      ...
      <Container>
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          {benefitsContent.map((benefit, index) => (
            <article className="premium-card relative overflow-hidden p-6" key={benefit.title}>
              ...
              <div className="relative">
                ...
                <h3 className="font-display text-xl font-semibold text-white sm:text-2xl">{benefit.title}</h3>
