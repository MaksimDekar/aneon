      ...
      <Container>
        <div className="glass-panel margiela-stitches grid gap-10 p-6 sm:p-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <div className="mt-7 inline-flex rounded-xl border border-white/15 bg-white/5 px-4 py-3 text-sm text-white/80">
          ...
          <div className="relative">
            ...
            <img
              ...
              className="relative h-[320px] w-full rounded-2xl border border-white/10 object-cover sm:h-[420px]"
